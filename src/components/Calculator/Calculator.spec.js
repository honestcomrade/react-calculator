...
describe('Calculator', () => {
  ...
  it('should have the class calculator-container', () => {
    expect(wrapper.find('div').hasClass('calculator-container')).toEqual(true);
  });
...
describe('setOperator', () => {
  ...
  it('selectedOperator is not an empty string, does not updated storedValue', () => {
    wrapper.setState({displayValue: '5'});
    wrapper.instance().setOperator('+');
    expect(wrapper.state('storedValue')).toEqual('5');
    wrapper.instance().setOperator('-');
